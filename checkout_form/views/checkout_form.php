...
<div style="width:100%; text-align:center;">
 <h1 style="font-size:90px;">SZYMON MUDRAK</h1>
...
<div style="width:100%; text-align:center;">
 ...
 <p style="width:50%; margin:auto;">Dzień dobry, z racji chwilowej niekomfortowej sytuacji i dużej ilości rzeczy prywatnych na głowie przez ostatni tydzień nie miałem za dużo czasu na przyjemności i pisanie kodu
    ...
    <br>
    <br>
    Link do bazy danych: https://s147.cyber-folks.pl/phpmyadmin/index.php?route=/sql&pos=0&eq=O1yLRMR70pQE_ft-0-Cuv9LKJENRFJShUZr8AA6RVv_tFf1GMpVcSAa2oull7Dam9iEln5lxfz-Po51v9XlV7CWi7mRBdWo2M_ffdsXDUdchjEzmv05nnVk%3D
    <br>
    <br>
